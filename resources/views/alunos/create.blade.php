    ...
    <main>
        ...
        <section id="maincontentform">
            <div id="linetop" class="linetop">
                <h1 id="h1alert">ADICIONAR ALUNO</h1>
            </div>
                        ...
                        <div class="ladoesquerdoform">
                            ...
                            <div class="compact">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"id="rg" name="rg" placeholder="00.000.000-00"
                                        maxlength="13" pattern="\d{2}\.\d{3}\.\d{3}-[\d{2}]">
                                </div>
                            </div><!--compact-->
                            <div class="compact">
                                <div class="form-group">
                                    <label for="telefone">TELEFONE:</label>
                                    <input class="smallinput" type="tel" id="telefone" name="telefone"
                                        maxlength="15" placeholder="(00) 00000-0000">
                                </div>
                                <div class="form-group">
                                    <label for="telefone_familia">TELEFONE FAMILIAR:</label>
                                    <input type="tel" id="telefone_familia" maxlength="15"
                                        name="telefone_familiar" placeholder="(00) 00000-0000">
                                </div>
                            </div><!--compact-->
                            <div class="form-group">
                        ...
                        <div class="ladodireitoform">
                            ...
                            <div class="compact">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="rua" name="endereco[rua]"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cidade" name="endereco[cidade]"
                                        placeholder="Digite sua cidade" value="RETIROLÂNDIA-BA">
                                </div>
                            </div><!--compact-->
                            <div class="compact">
                                <div class="form-group">
        ...
        <div class="conteudo-anamnese">
            <div class="ladoesquerdoform">
                ...
                <div class="compact">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="dorme_bem" name="dorme_bem"
                ...
                <div class="compact">
                    <div class="form-group">
                        ...
                        <select class="smallinput" id="lesao_articular" name="lesao_articular"
                            onchange="toggleLesaoInput(this)">
                        ...
                        <div id="lesao_detalhes" style="display: none; margin-top: 10px;">
                            ...
                            <input type="text" id="lesao_detalhes_input" name="lesao_detalhes"
                    ...
                    <div class="form-group">
                        ...
                        <div id="coluna_detalhes" style="display: none; margin-top: 8px;">
                            ...
                            <input type="text" id="coluna_detalhes_input" name="coluna_detalhes"
                ...
                <div class="compact">
                    <div class="form-group">
                        ...
                        <select class="smallinput" id="doenca_cardiaca" name="doenca_cardiaca"
                            onchange="toggledoencaInput(this)">
                            <option value="" disabled selected>Selecione</option>
                            <option value="Sim - ">Sim</option>
                            <option value="Não">Não</option>>
                        </select>
                        <div id="doenca_detalhes" style="display: none; margin-top: 10px;">
                            ...
                            <input type="text" id="doenca_detalhes_input" name="doenca_detalhes"
                ...
                <table id="tabela-parq">
                    ...
                    <tr id="linha-1">
                        <td class="sim" id="sim1"><label id="label-sim1"><input type="radio"
                                    value="sim" name="par_q1" id="input-sim1"></label></td>
                        <td class="nao" id="nao1"><label id="label-nao1"><input type="radio"
                                    value="" name="par_q1" id="input-nao1"></label></td>
                    ...
                    <tr id="linha-2">
                        <td class="sim" id="sim2"><label id="label-sim2"><input type="radio"
                                    value="sim" name="par_q2" id="input-sim2"></label></td>
                        <td class="nao" id="nao2"><label id="label-nao2"><input type="radio"
                                    value="" name="par_q2" id="input-nao2"></label></td>
                        <td class="questao" id="questao2">2- Você sente dor no peito quanto pratica atividade física?
                        </td>
                    </tr>
                    <tr id="linha-3">
                        <td class="sim" id="sim3"><label id="label-sim3"><input type="radio"
                                    value="sim" name="par_q3" id="input-sim3"></label></td>
                        <td class="nao" id="nao3"><label id="label-nao3"><input type="radio"
                                    value="" name="par_q3" id="input-nao3"></label></td>
                        <td class="questao" id="questao3">3- No mês passado, você teve dor no peito quanto não estava
                            praticando atividade física?</td>
                    </tr>
                    <tr id="linha-4">
                        <td class="sim" id="sim4"><label id="label-sim4"><input type="radio"
                                    value="sim" name="par_q4" id="input-sim4"></label></td>
                        <td class="nao" id="nao4"><label id="label-nao4"><input type="radio"
                                    value="" name="par_q4" id="input-nao4"></label></td>
                        <td class="questao" id="questao4">4- Você perde o equilíbrio devido a tonturas ou alguma vez
                            perdeu a consciência?</td>
                    </tr>
                    <tr id="linha-5">
                        <td class="sim" id="sim5"><label id="label-sim5"><input type="radio"
                                    value="sim" name="par_q5" id="input-sim5"></label></td>
                        <td class="nao" id="nao5"><label id="label-nao5"><input type="radio"
                                    value="" name="par_q5" id="input-nao5"></label></td>
                        <td class="questao" id="questao5">5- Você tem problema ósseo ou articular que poderia ficar
                            pior por alguma mudança em sua atividade física?</td>
                    </tr>
                    <tr id="linha-6">
                        <td class="sim" id="sim6"><label id="label-sim6"><input type="radio"
                                    value="sim" name="par_q6" id="input-sim6"></label></td>
                        <td class="nao" id="nao6"><label id="label-nao6"><input type="radio"
                                    value="" name="par_q6" id="input-nao6"></label></td>
                        <td class="questao" id="questao6">6- Seu médico está atualmente receitando algum remédio (por
                            exemplo, diuréticos) para pressão arterial ou problema cardíaco?</td>
                    </tr>
                    <tr id="linha-7">
                        <td class="sim" id="sim7"><label id="label-sim7"><input type="radio"
                                    value="sim" name="par_q7" id="input-sim7"></label></td>
                        <td class="nao" id="nao7"><label id="label-nao7"><input type="radio"
                                    value="" name="par_q7" id="input-nao7"></label></td>
            ...
            <div class="ladodireitoform">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="soubeDa_academia" name="como_soube_da_academia"
                ...
                <table id="tabela-medidas">
                    ...
                    <tr id="linha-antebracos">
                        ...
                        <td class="input-coluna" id="td-antebracos"><input id="input-antebracos" type="text"
                                name="medida[antebracos]" placeholder="Centímetros"></td>
                    </tr>
                    <tr id="linha-pernas">
                        <th id="th-pernas">PERNA (direita e esquerda):</th>
                        <td class="input-coluna" id="td-pernas"><input id="input-pernas" type="text"
                                name="medida[pernas]" placeholder="Centímetros"></td>
                    </tr>
                    <tr id="linha-panturrilha">
                        <th id="th-panturrilha">PANTURRILHA (direita e esquerda):</th>
                        <td class="input-coluna" id="td-panturrilha"><input id="input-panturrilha" type="text"
                                name="medida[panturrilha]" placeholder="Centímetros"></td>
                    </tr>
                    <tr id="linha-observacoes">
                        <th id="th-observacoes">OBSERVAÇÕES:</th>
                        <td class="input-coluna" id="td-observacoes"><input id="input-observacoes" type="text"
                                name="medida[obs]" placeholder="Observações"></td>
                    </tr>
                </table>
            </div><!--ladodireitoform-->
            </form><!--formanamnese-->
