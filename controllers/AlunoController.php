...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['mostrarAtivado'])) {
        try {
            $database = new Database();
            $conexao = $database->getConnection();
            $alunos = Aluno::listarTodos($conexao);
            $contador = 1;
    ...
    } elseif (isset($_POST['mostrarDesativado'])) {
        try {
            $database = new Database();
        $conexao = $database->getConnection();
    ...
    elseif (isset($_POST['pagamentofuturo'])) {
        $nome = $_POST['pagamentofuturo'];
        try {
            $database = new Database();
            $conexao = $database->getConnection();
    
            $clientes = new Pagamento();
            $usuarios = $clientes->listarTodosFuturos();
            $contador = 1;
            echo '
            <table id="tabelaresultado" border="1" style="margin-bottom:10px;">
                <thead>
    ...
    elseif (isset($_POST['pagamentoignorado'])) {
        $nome = $_POST['pagamentoignorado'];
        try {
            $database = new Database();
            $conexao = $database->getConnection();
    
            $clientes = new Pagamento();
            $usuarios = $clientes->listarTodosIgnorados();
            $contador = 1;
