...
// Supondo que a classe que contém a função 'buscarPagamentosAtrasados' esteja instanciada como $clientes
$usuarios = $clientes->buscarPagamentosAtrasados();

if (!empty($usuarios)) {
    foreach ($usuarios as $usuario) {
        // Convertendo a data para o formato desejado
        $dataVencimento = date('d/m/Y', strtotime($usuario['data_vencimento'])); 
    ...
    echo "<tr><td colspan='5'>Nenhum pagamento pendente.</td></tr>";
}
?>
